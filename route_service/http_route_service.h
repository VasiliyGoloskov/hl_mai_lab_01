#ifndef HTTPROUTESERVICE_H
#define HTTPROUTESERVICE_H
...
#include "../web_server/handlers/route_handler.h"

class RouteOtherHandler : public HTTPRequestHandler
{

public:
    RouteOtherHandler(const std::string &format) : _format(format)
    {
    }
...
class HTTPRouteOtherWebServer : public Poco::Util::ServerApplication
{
public:
